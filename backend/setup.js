...
const reset = async () => {
    ...
    await db.Plant.bulkCreate([
        ...
        {
            name: "스파티필름",
            feature: "1. <꽃> 하얀색 꽃을 피워요.\n" +
                "2. <기능> NASA가 발표한 공기정화식물로 실내 공기 오염물질을 분해하는 능력이 뛰어나요. 물에 꽂아 두기만 해도 가습기 역할을 하며, 물주기만 적당히 주의해주면 큰 문제 없이 잘 자라는 편이에요.",
            warning: "1. 잎이 변색되면 해당 부분은 가지치기를 해주세요!\n" +
        ...
        {
            name: "필레아페페",
            feature: "1. <잎> 꽃이 피지는 않지만 사계절 내내 동글동글한 초록 잎을 볼 수 있어요. 줄기를 잘라서 삽목하면 여러 개의 화분을 만들 수 있답니다.\n" +
                "1. <잎> 꽃이 피지는 않지만 사계절 내내 동글동글한 초록 잎을 볼 수 있어요. 줄기를 잘라서 삽목하면 여러 개의 화분을 만들 수 있답니다.",
            warning: "1. 추위에 약하기 때문에 실내에서 재배해야 해요.\n" +
                "2. 잎이 해를 향해 자라는 편이나 직사광선을 강하게 받으면 잎이 변색될 수 있어요.\n" +
        ...
        {
            name: "스킨답서스",
            feature: "1. <기능> 공기 정화력이 뛰어난 식물이에요. 병충해에 강하고 햇빛을 많이 볼 필요가 없어서 키우기 수월한 식물 중 하나에요.",
            warning: "1. 스킨답서스의 잎에 들어있는 성분은 애완동물에게는 독이 될 수 있기 때문에 반려동물을 키우는 집이라면 피하는 것이 좋아요.\n" +
        ...
        {
            name: "트리안",
            feature: "1. <잎> 덩굴 식물답게 길게 길게 자라요. 잎이 작고 동글동글한 것이 특징이에요.",
            warning: "1. 성장 속도가 빠르므로 원하는 모양으로 키우려면 틈틈히 잘라주어야 해요.\n" +
                "2. 물을 많이 줄 경우 뿌리가 상할 수 있어요.\n" +
        ...
        {
            name: "마리모",
            feature: "1. <잎> 공 모양으로 뭉쳐서 자라요. 동그랗고 신기한 생김새 덕인지 애완 식물로 은근히 인기가 있는 편이에요. 1년에 약 5mm 자라요.",
            warning: "1. 물 온도를 20℃ 정도로 맞춰주는 것이 좋아요.\n" +
                "2. 가끔 마리모 볼을 회전시켜 빛이 여러 방향에 닿을 수 있도록 해주세요.\n" +
        ...
        {
            name: "벵갈고무나무",
            feature: "1. <기능> 공기 정화 능력이 매우 우수한 식물이에요.",
            warning: "1. 성장속도가 빠르기 때문에 자주 가지치기를 해 줘야 해요. 가지치기를 할 경우 독성이 있는 수액이 나와서 주의해야 해요.\n" +
        ...
        {
            name: "디시디아",
            feature: "1. <꽃> 따뜻한 온도와 빛이 있으면 2~3mm의 시트러스 향 흰색 꽃을 피워요.\n" +
            "2. <기능> 착생식물로 흙이 필요없고 걸어두기 때문에 인테리어 효과가 있어요.",
            warning: "1. 줄기를 자를 시 독성이 있는 수액이 나오지만, 독성 자체는 미미해요.\n" +
